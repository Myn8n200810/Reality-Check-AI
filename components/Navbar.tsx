  ...
  return (
    <div className="absolute top-4 left-4 z-50">
      <button
        ...
        className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-xl flex items-center justify-center border border-white/10"
      >
      ...
      {open && (
        <div className="mt-3 w-64 rounded-2xl bg-black/85 backdrop-blur-xl border border-white/10 shadow-xl p-2 space-y-1">
          ...
          <button onClick={closeBothMenus} className="flex items-center gap-3 w-full px-4 py-2 hover:bg-white/10 rounded-xl">
            <svg className="w-5 h-5 text-white/70" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
